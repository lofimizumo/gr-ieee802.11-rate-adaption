...
import foo
import my_rx_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class my_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "my_rx")
        ...
        self.uhd_usrp_source_0_0.set_center_freq(uhd.tune_request(freq, rf_freq = freq - lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
        ...
        self.foo_packet_pad_0 = foo.packet_pad(False, False, 0.001, 0, 0)
        self.epy_block_0 = epy_block_0.message_handler()
        ...
        self.msg_connect((self.wifi_phy_hier_0, 'mac_out'), (self.epy_block_0, 'in'))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.foo_packet_pad_0, 0))
        self.connect((self.foo_packet_pad_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.wifi_phy_hier_0, 0))
    ...
    def set_lo_offset(self, lo_offset):
        ...
        self._lo_offset_callback(self.lo_offset)
        self.uhd_usrp_source_0_0.set_center_freq(uhd.tune_request(self.freq, rf_freq = self.freq - self.lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
...
def main(top_block_cls=my_rx, options=None):
